...
public class AppUtils {
    ...
    public static final String WELCOME_MAIL_TEMPLATE_LOCATION = "/welcomeTemplate.txt";
    public static final String MEMBER_WELCOME_MAIL_TEMPLATE_LOCATION = "/memberWelcomeTemplate.txt";
    public static final String WELCOME_MAIL_SUBJECT= "Welcome to %s Community";
